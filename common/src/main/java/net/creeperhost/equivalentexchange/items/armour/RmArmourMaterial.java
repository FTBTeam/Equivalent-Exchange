...
public class RmArmourMaterial implements ArmorMaterial
{
    public static final RmArmourMaterial INSTANCE = new RmArmourMaterial();
    ...
    {
        return new ResourceLocation(Constants.MOD_ID, "red_matter").toString();
    }
