...
public class ScreenRelayMK1 extends AbstractContainerScreen<ContainerRelayMK1> implements IEmcScreen
{
    public ScreenRelayMK1(ContainerRelayMK1 containerRelay, Inventory inventory, Component component)
    {
    ...
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY)
    {
        ...
        //TODO clean this up
        ResourceLocation texture = new ResourceLocation(Constants.MOD_ID, "textures/gui/relay1.png");
        int emcShift = 64;
        int v = 177;
