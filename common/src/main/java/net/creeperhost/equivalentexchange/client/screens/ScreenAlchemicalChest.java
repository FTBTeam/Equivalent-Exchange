...
public class ScreenAlchemicalChest extends ContainerGuiProvider<ContainerAlchemicalChest> implements DynamicTextures
{
    @Override
    ...
    @Override
    public void buildGui(ModularGui modularGui, ContainerScreenAccess<ContainerAlchemicalChest> screenAccess)
    {
        var menu = screenAccess.getMenu();
        modularGui.initStandardGui(260, 250);
        modularGui.setGuiTitle(Component.translatable("block.equivalentexchange.alchemical_chest"));
    ...
    public static ModularGuiContainer<ContainerAlchemicalChest> create(ContainerAlchemicalChest menu, Inventory inventory, Component component)
    {
        return new ModularGuiContainer<>(menu, inventory, new ScreenAlchemicalChest());
    }
}
