...
public class ScreenRelayMK2 extends AbstractContainerScreen<ContainerRelayMK2> implements IEmcScreen
{
    public ScreenRelayMK2(ContainerRelayMK2 containerRelay, Inventory inventory, Component component)
    {
    ...
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY)
    {
        ...
        //TODO clean this up
        ResourceLocation texture = new ResourceLocation(Constants.MOD_ID, "textures/gui/relay2.png");
        int emcShift = 86;
        int v = 183;
