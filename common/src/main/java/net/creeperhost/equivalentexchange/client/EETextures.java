...
public class EETextures
{
    private static final ModAtlasHolder ATLAS_HOLDER = new ModAtlasHolder(Constants.MOD_ID, "textures/atlas/gui.png", "gui");
    ...
    {
        return new Material(ATLAS_HOLDER.atlasLocation(), new ResourceLocation(Constants.MOD_ID, "gui/" + texture), ATLAS_HOLDER::getSprite);
    }
}
